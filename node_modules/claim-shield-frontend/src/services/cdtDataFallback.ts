...
export const FALLBACK_CDT_LIBRARY: CdtKnowledgeEntry[] = [
  {
    cdt_code: 'D2740',
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Requires pre-op bitewing or PA showing decay into dentin or cusp fracture.',
      'Cigna': 'Intraoral photo accepted if fracture line is undetectable on 2D radiograph.',
      'MetLife': 'Requires documented prognosis for entire dentition when multiple units billed.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'May downgrade to D2790 or D2751 if noble alloy content is unspecified on lab slip.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Denies D2950 if tooth has sufficient natural walls to retain crown prep.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    description: 'Direct tooth-colored resin restoration placed on one anterior tooth surface.',
    clinical_concepts: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Must show 4+ qualifying teeth with 4mm+ pockets and radiographic bone loss in quadrant.',
      'Cigna': 'Perio chart must be dated within 12 months of service date.',
      'MetLife': 'Limits to maximum 2 quadrants on the same date of service unless narrative explains sedation/special circumstance.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Requires proof of prior active perio therapy before covering D4910 under perio benefits.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Routinely downgrades to simple extraction D7140 without explicit surgical operative notes.',
      'Cigna': 'Must describe: (1) flap design, (2) bone removal, and/or (3) sectioning method.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Many commercial dental plans categorize socket preservation as non-covered elective unless plan has explicit implant rider.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Requires both pre-op diagnostic radiograph and post-obturation radiograph showing all canals filled.',
      'Cigna': 'Canals filled >2mm short of radiographic apex or gross overfill may trigger consultant review.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Implant rider required on subscriber contract. Delta will deny if missing pre-op and post-placement films.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Standard limit: two evaluations per calendar or benefit year, spaced 6 months apart.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Cigna': 'Frequency limited to once every 36 or 60 months per provider/practice.'
    },
    risk_factors: [
  ...
  },
  {
    ...
    payer_specific_requirements: {
      'Delta Dental': 'Covered once every 3 to 5 years. Individual PAs and bitewings taken same day will be bundled into FMX.'
    },
    risk_factors: [
...
export function searchFallbackCdtLibrary(params?: {
  category?: string;
  search?: string;
  risk?: string;
}): CdtKnowledgeEntry[] {
  let results = [...FALLBACK_CDT_LIBRARY];
  ...
  if (params?.risk && params.risk !== 'ALL') {
    results = results.filter(
      item => item.risk_level.toUpperCase() === params.risk!.toUpperCase()
    );
  }
