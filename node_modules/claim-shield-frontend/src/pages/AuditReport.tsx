...
export const AuditReport: React.FC<AuditReportProps> = ({
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      ...
      {/* 5.5 Payer Rejection Intelligence Card */}
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden space-y-0">
        {/* Dark Header Bar */}
        <div className="bg-[#0b132b] p-5 sm:p-6 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base sm:text-lg font-extrabold text-white tracking-wider uppercase">
                  PAYER REJECTION INTELLIGENCE
                </h3>
              </div>
              <p className="text-xs text-blue-300/80 font-medium mt-0.5">
                Learned from 29 historical payer outcomes
              </p>
            </div>
          </div>
        ...
        <div className="p-6 space-y-6 bg-white">
          ...
          {/* Most Likely Rejection Reason Box */}
          <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1">
              <span className="bg-blue-600 text-white text-[10px] font-extrabold uppercase tracking-wider px-2 py-0.5 rounded inline-block">
                MOST LIKELY REJECTION REASON
              </span>
              <h4 className="text-base sm:text-lg font-extrabold text-slate-900 mt-1">
                Missing supporting radiograph
              </h4>
              <p className="text-xs text-blue-600 font-semibold flex items-center gap-1">
                Matched 8 similar rejected claims.
              </p>
            </div>

            <div className="bg-blue-600 text-white px-4 py-2.5 rounded-xl text-center shadow-xs shrink-0 self-start sm:self-auto">
              <span className="text-xl font-black block leading-none">39%</span>
              <span className="text-[9px] font-bold uppercase tracking-wider block opacity-90 mt-0.5">pattern score</span>
            </div>
          </div>

          {/* Common Rejection Patterns List */}
          <div className="space-y-3">
            <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-slate-500">
              <TrendingUp className="w-3.5 h-3.5 text-slate-400" />
              <span>COMMON REJECTION PATTERNS</span>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-800">Missing supporting radiograph</span>
                  <span className="font-bold text-slate-700 font-mono">39%</span>
                </div>
                <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden">
                  <div className="bg-blue-600 h-full rounded-full" style={{ width: '39%' }} />
                </div>
              </div>
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-800">Insufficient clinical justification</span>
                  <span className="font-bold text-slate-700 font-mono">35%</span>
                </div>
                <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-800">Documentation / tooth mismatch</span>
                  <span className="font-bold text-slate-700 font-mono">25%</span>
                </div>
                <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden">
          ...
          {/* Card Footer */}
          <div className="pt-2 border-t border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-[11px] text-slate-400 font-medium">
            <span>Model: Payer Pattern Learner v1 (similarity-weighted k-NN)</span>
            <span>21 similar claims considered</span>
          </div>
        </div>
      </div>
